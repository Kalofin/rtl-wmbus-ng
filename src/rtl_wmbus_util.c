...
int make_time_string(char* timestamp, size_t timestamp_size)
{
  ...
  // empty timestamp to get the same output with every run
  snprintf(timestamp, timestamp_size, "<timestamp>");
